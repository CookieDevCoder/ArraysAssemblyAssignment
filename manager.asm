...
segment .data
    intro db "This Program will manage your sequence of 64-bit floats", 10, "For the array enter a sequence of 64-bit floats separated by white space.", 0
    askforfloats db "After the last input, press enter followed by ctrl+D:", 0
    inputnotice db "These numbers were recieved and placed into an array"
